// Generated by gencpp from file smart_car/MovementBezier.msg
// DO NOT EDIT!


#ifndef SMART_CAR_MESSAGE_MOVEMENTBEZIER_H
#define SMART_CAR_MESSAGE_MOVEMENTBEZIER_H
...
struct MovementBezier_
{
  ...
  typedef boost::shared_ptr< ::smart_car::MovementBezier_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::smart_car::MovementBezier_<ContainerAllocator> const> ConstPtr;

}; // struct MovementBezier_

typedef ::smart_car::MovementBezier_<std::allocator<void> > MovementBezier;

typedef boost::shared_ptr< ::smart_car::MovementBezier > MovementBezierPtr;
typedef boost::shared_ptr< ::smart_car::MovementBezier const> MovementBezierConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::smart_car::MovementBezier_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::smart_car::MovementBezier_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::smart_car::MovementBezier_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::smart_car::MovementBezier_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::smart_car::MovementBezier_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::smart_car::MovementBezier_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::smart_car::MovementBezier_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::smart_car::MovementBezier_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::smart_car::MovementBezier_<ContainerAllocator> >
{
  ...
  static const char* value(const ::smart_car::MovementBezier_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xded95d34881d8c48ULL;
  static const uint64_t static_value2 = 0x0a26fcec4fc049dfULL;
};

template<class ContainerAllocator>
struct DataType< ::smart_car::MovementBezier_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::smart_car::MovementBezier_<ContainerAllocator> >
{
  static const char* value()
  {
    return "uint8 frame\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::smart_car::MovementBezier_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::smart_car::MovementBezier_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::smart_car::MovementBezier_<ContainerAllocator>& v)
  {
    s << indent << "frame: ";
...
#endif // SMART_CAR_MESSAGE_MOVEMENTBEZIER_H
