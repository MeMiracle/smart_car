...
(cl:defclass <Movement> (roslisp-msg-protocol:ros-message)
  ((movement
   ...
   (wheel
    :reader wheel
    :initarg :wheel
    :type smart_car-msg:Velocity
    :initform (cl:make-instance 'smart_car-msg:Velocity))
   (generic
    :reader generic
    :initarg :generic
    :type smart_car-msg:MovementGeneric
    :initform (cl:make-instance 'smart_car-msg:MovementGeneric))
   (bezier
    :reader bezier
    :initarg :bezier
    :type smart_car-msg:MovementBezier
    :initform (cl:make-instance 'smart_car-msg:MovementBezier)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Movement>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Movement)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smart_car-msg:<Movement> is deprecated: use smart_car-msg:Movement instead.")))

(cl:ensure-generic-function 'movement-val :lambda-list '(m))
(cl:defmethod movement-val ((m <Movement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:movement-val is deprecated.  Use smart_car-msg:movement instead.")
  (movement m))

(cl:ensure-generic-function 'wheel-val :lambda-list '(m))
(cl:defmethod wheel-val ((m <Movement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:wheel-val is deprecated.  Use smart_car-msg:wheel instead.")
  (wheel m))

(cl:ensure-generic-function 'generic-val :lambda-list '(m))
(cl:defmethod generic-val ((m <Movement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:generic-val is deprecated.  Use smart_car-msg:generic instead.")
  (generic m))

(cl:ensure-generic-function 'bezier-val :lambda-list '(m))
(cl:defmethod bezier-val ((m <Movement>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:bezier-val is deprecated.  Use smart_car-msg:bezier instead.")
  (bezier m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Movement>)))
  ...
  (cl:format cl:nil "uint8 movement~%smart_car/Velocity wheel~%smart_car/MovementGeneric generic~%smart_car/MovementBezier bezier~%# movement constants~%uint8 BEZIER=0~%uint8 GENERIC=1~%uint8 NONE=2~%uint8 WHEEL=3~%# type constants~%uint8 POSITION_ABSOLUTE=0~%uint8 POSITION_RELATIVE=1~%uint8 VELOCITY=2~%# frame constants~%uint8 HYBRID=0~%uint8 MOBILE=1~%uint8 MOBILE_RAW=2~%uint8 WORLD=3~%~%================================================================================~%MSG: smart_car/Velocity~%float64 v_left~%float64 v_back~%float64 v_right~%~%================================================================================~%MSG: smart_car/MovementGeneric~%uint8 type~%uint8 frame~%geometry_msgs/Pose2D target~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# Deprecated~%# Please use the full 3D pose.~%~%# In general our recommendation is to use a full 3D representation of everything and for 2D specific applications make the appropriate projections into the plane for their calculations but optimally will preserve the 3D information during processing.~%~%# If we have parallel copies of 2D datatypes every UI and other pipeline will end up needing to have dual interfaces to plot everything. And you will end up with not being able to use 3D tools for 2D use cases even if they're completely valid, as you'd have to reimplement it with different inputs and outputs. It's not particularly hard to plot the 2D pose or compute the yaw error for the Pose message and there are already tools and libraries that can do this for you.~%~%~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%================================================================================~%MSG: smart_car/MovementBezier~%uint8 frame~%geometry_msgs/Pose2D[] targetTranslation~%float64[] targetRotation~%float64 step~%bool offsetTraslation~%bool offsetRotation~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Movement)))
  "Returns full string definition for message of type 'Movement"
  (cl:format cl:nil "uint8 movement~%smart_car/Velocity wheel~%smart_car/MovementGeneric generic~%smart_car/MovementBezier bezier~%# movement constants~%uint8 BEZIER=0~%uint8 GENERIC=1~%uint8 NONE=2~%uint8 WHEEL=3~%# type constants~%uint8 POSITION_ABSOLUTE=0~%uint8 POSITION_RELATIVE=1~%uint8 VELOCITY=2~%# frame constants~%uint8 HYBRID=0~%uint8 MOBILE=1~%uint8 MOBILE_RAW=2~%uint8 WORLD=3~%~%================================================================================~%MSG: smart_car/Velocity~%float64 v_left~%float64 v_back~%float64 v_right~%~%================================================================================~%MSG: smart_car/MovementGeneric~%uint8 type~%uint8 frame~%geometry_msgs/Pose2D target~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# Deprecated~%# Please use the full 3D pose.~%~%# In general our recommendation is to use a full 3D representation of everything and for 2D specific applications make the appropriate projections into the plane for their calculations but optimally will preserve the 3D information during processing.~%~%# If we have parallel copies of 2D datatypes every UI and other pipeline will end up needing to have dual interfaces to plot everything. And you will end up with not being able to use 3D tools for 2D use cases even if they're completely valid, as you'd have to reimplement it with different inputs and outputs. It's not particularly hard to plot the 2D pose or compute the yaw error for the Pose message and there are already tools and libraries that can do this for you.~%~%~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%================================================================================~%MSG: smart_car/MovementBezier~%uint8 frame~%geometry_msgs/Pose2D[] targetTranslation~%float64[] targetRotation~%float64 step~%bool offsetTraslation~%bool offsetRotation~%~%~%"))
