...
(cl:defmethod cl:initialize-instance :after ((m <MovementBezier>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MovementBezier)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smart_car-msg:<MovementBezier> is deprecated: use smart_car-msg:MovementBezier instead.")))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <MovementBezier>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:frame-val is deprecated.  Use smart_car-msg:frame instead.")
  (frame m))

(cl:ensure-generic-function 'targetTranslation-val :lambda-list '(m))
(cl:defmethod targetTranslation-val ((m <MovementBezier>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:targetTranslation-val is deprecated.  Use smart_car-msg:targetTranslation instead.")
  (targetTranslation m))

(cl:ensure-generic-function 'targetRotation-val :lambda-list '(m))
(cl:defmethod targetRotation-val ((m <MovementBezier>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:targetRotation-val is deprecated.  Use smart_car-msg:targetRotation instead.")
  (targetRotation m))

(cl:ensure-generic-function 'step-val :lambda-list '(m))
(cl:defmethod step-val ((m <MovementBezier>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:step-val is deprecated.  Use smart_car-msg:step instead.")
  (step m))

(cl:ensure-generic-function 'offsetTraslation-val :lambda-list '(m))
(cl:defmethod offsetTraslation-val ((m <MovementBezier>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:offsetTraslation-val is deprecated.  Use smart_car-msg:offsetTraslation instead.")
  (offsetTraslation m))

(cl:ensure-generic-function 'offsetRotation-val :lambda-list '(m))
(cl:defmethod offsetRotation-val ((m <MovementBezier>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:offsetRotation-val is deprecated.  Use smart_car-msg:offsetRotation instead.")
  (offsetRotation m))
