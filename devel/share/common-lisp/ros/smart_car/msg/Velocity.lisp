...
(cl:defmethod cl:initialize-instance :after ((m <Velocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Velocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name smart_car-msg:<Velocity> is deprecated: use smart_car-msg:Velocity instead.")))

(cl:ensure-generic-function 'v_left-val :lambda-list '(m))
(cl:defmethod v_left-val ((m <Velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:v_left-val is deprecated.  Use smart_car-msg:v_left instead.")
  (v_left m))

(cl:ensure-generic-function 'v_back-val :lambda-list '(m))
(cl:defmethod v_back-val ((m <Velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:v_back-val is deprecated.  Use smart_car-msg:v_back instead.")
  (v_back m))

(cl:ensure-generic-function 'v_right-val :lambda-list '(m))
(cl:defmethod v_right-val ((m <Velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader smart_car-msg:v_right-val is deprecated.  Use smart_car-msg:v_right instead.")
  (v_right m))
